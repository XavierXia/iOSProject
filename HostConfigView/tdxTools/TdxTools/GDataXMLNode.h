...
-(NSString *)GetAttributeStringValue:(NSString *)attributename;
-(int)GetAttrbuteIntValue:(NSString	 *)attributename;
-(BOOL)GetAttrbuteBoolValue:(NSString	 *)attributename;
-(BOOL)IsAttriExit:(NSString *)attributename;
@end
